...
#include "navmesh/lua_cocos2dx_navmesh_manual.h"
#include "tolua/lua_cocos2dx_custom.hpp"
#include "tolua/lua_CustomInterface.h"
#include "tolua/lua_assetsmanager_test_sample.h"
...
static int lua_module_register(lua_State* L)
{
	...
	tolua_CustomInterface_open(L);
	register_lutils_module(L);
	return 1;
}
