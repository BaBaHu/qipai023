#ifndef _FourMJClientKernelSink_H_
#define _FourMJClientKernelSink_H_
...
//游戏引擎
class FourMJClientKernelSink : public ClientKernelSink
{
	//函数定义
public:
	//构造函数
	FourMJClientKernelSink();
	//析构函数
	virtual ~FourMJClientKernelSink();
...
#endif // _FourMJClientKernelSink_H_