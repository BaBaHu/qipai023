#ifndef _TwoHZBClientKernelSink_H_
#define _TwoHZBClientKernelSink_H_
...
//游戏引擎
class TwoHZBClientKernelSink : public ClientKernelSink
{
	//函数定义
public:
	//构造函数
	TwoHZBClientKernelSink();
	//析构函数
	virtual ~TwoHZBClientKernelSink();
...
protected:
	...
	bool OnGameQianGangResult(void* data, word wSize);		// 没有调用
};

#endif // _TwoHZBClientKernelSink_H_