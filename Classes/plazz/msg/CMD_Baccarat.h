...
//玩家索引
#define ID_XIAN_JIA					0									//闲家索引
#define ID_PING_JIA					1									//平家索引
#define ID_ZHUANG_JIA				2									//庄家索引
#define ID_XIAN_TIAN_WANG			3									//闲天王
#define ID_ZHUANG_TIAN_WANG			4									//庄天王
#define ID_TONG_DIAN_PING			5									//同点平
#define ID_PLAYER_TWO_PAIR			6									//闲对子
#define ID_BANKER_TWO_PAIR			7									//庄对子
...
struct tagServerGameRecord
{
	...
	bool							bPlayerTwoPair;						//闲家对子标识
	bool							bBankerTwoPair;						//庄家对子标识
...
#define SUB_S_RESORT_BANKER			112									//重排序庄家
...
struct CMD_S_StatusFree
{
	...
	//房间信息
	char							szGameRoomName[2*SERVER_LEN];			//房间名称
...
{
	word		wCurBanker;					//当前庄家
	word		wUserCount;					//玩家数量
	word		wUserChairID[100];			//玩家椅子ID
};
